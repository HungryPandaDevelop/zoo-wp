...
const ftpConfig = {
  host: '147.45.160.205',
  user: 'panda',
  password: 'yJm8YnjpiR6#KS',
  port: 21,
  remotePath: '/sites/zoonika/wp-content/themes/zoonika' // Укажите путь на FTP-сервере, куда вы хотите загружать файлы
};
...
function compileJS() {
  return gulp.src([
    ...
    // 'js-sourse/search-ajax-input.js',
    ...
    'js-sourse/comments.js',
    'js-sourse/map/item-companies.js',
    'js-sourse/map/item-sales.js',
    'js-sourse/map/main.js',
    'js-sourse/end.js'
  ])
    .pipe(plumber())
    .pipe(sourcemap.init())
...
function deploy() {
  return gulp.src(['**/*', '!node_modules/**']) // Путь к вашим файлам, которые вы хотите загрузить
...
function watchFiles() {
  ...
  // gulp.watch(['**/*', '!node_modules/**'], deploy).on('error', handleError);
}
