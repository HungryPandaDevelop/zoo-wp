...
import PostItem from '/src/pages/cabinet/pets/Item';
...
const List = () => {
  ...
  useEffect(() => {
    ...
    dispatch(getPosts({ id: userData.user_id, type: 'pets' }));
  }, []);
  ...
  return (
    <div className='posts-list'>
      <Link className='btn btn--blue-border long-btn' to="/cabinet/pets/new">+ Добавить родителя</Link>
