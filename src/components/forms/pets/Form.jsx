  ...
  return (
    ...
    >
      ...
      <div className="cabinet-form-container">
        ...
        <div className="input-box">
          <label><b>2. {inputs.genderPets.placeholder}</b>
          </label>
          <RenderInput param={{ ...inputs.genderPets, checkErrorSubmit }} />
        </div>
        <div className="input-box">
          <label><b>3. {inputs.title.placeholder}</b></label>
          <RenderInput param={{ ...inputs.title, checkErrorSubmit }} />
        </div>
        <div className="input-box">
          <label><b>4. {inputs.birth.placeholder}</b>
          </label>
          <RenderInput param={{ ...inputs.birth, checkErrorSubmit }} />
        </div>
        <div className="input-box">
          <label><b>5. {inputs.content.placeholder}</b>
        ...
        <div className="input-box">
          <label><b>6. {inputs.dokumenty_pitomca.placeholder}</b>
          </label>
          <RenderInput param={{ ...inputs.dokumenty_pitomca, checkErrorSubmit }} />
        </div>

        <div className="input-box">
          <label><b>7. {inputs.fotografia_pitomca.placeholder}</b>
        ...
        <div className="input-box">
          <label><b>8. {inputs.tituly.placeholder}</b>
        ...
        <div className="input-box">
          <label><b>9. {inputs.foto_roditelya.placeholder}</b>
        ...
        {race === 'porodi-sobak' && (
          <>
            <div className="input-box">
              <label><b>10. Дрессировка</b></label>
            </div>
            <div className="input-box">
...
const GenerateForm = reduxForm({
  form: 'petsForm'  // a unique identifier for this form
})(TemplateForm);
